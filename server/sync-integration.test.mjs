...
test('Sync import preserves existing content and is idempotent with scoped publication', async()=>{
 ...
 assert.equal((await req({...body,externalId:'bad-image',image:{...body.image,width:10}})).status,400);
