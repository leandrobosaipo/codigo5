export const capabilities = [
  {
    ...
    "items": [
      "Sites para empresas, profissionais e instituições",
      "Lojas virtuais e catálogos de produtos",
      "Páginas para divulgar serviços e campanhas",
      "Preços e estoque conectados ao sistema da loja",
      "Atualização de produtos e conteúdo pela sua equipe"
    ]
  },
  {
    "id": "audiencia",
    ...
    "items": [
      "Páginas que respondem às dúvidas do cliente",
      "Conteúdo para blogs e páginas de serviços",
      "Melhorias para a empresa aparecer nas buscas",
      "Relatórios de visitas em linguagem clara"
    ]
  },
  {
    "id": "editorial",
    ...
    "items": [
      "Criação e manutenção de portais de notícias",
      "Organização de pautas e publicação de conteúdo",
      "Preparação de imagens e vídeos",
      "Distribuição de chamadas para os canais do portal",
      "Gestão de anúncios e comprovantes de veiculação"
    ]
  },
  {
    "id": "sistemas",
    ...
    "items": [
      "Sistemas para acompanhar pedidos, contatos e tarefas",
      "Conexão entre site, atendimento e gestão",
      "Organização de cadastros e remoção de duplicados",
      "Painéis de acompanhamento comercial e financeiro",
      "Transcrição de áudio e apoio à produção de conteúdo"
    ]
  },
  {
    "id": "operacao",
    ...
    "items": [
      "Hospedagem, domínio e e-mail profissional",
      "Atualizações e correção de problemas",
      "Cópias de segurança e acompanhamento do site",
      "Mudança de hospedagem e recuperação de sites",
      "Suporte para ajustes e melhorias"
    ]
  }
];
